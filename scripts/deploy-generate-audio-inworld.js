...
/**
 * Script to deploy generate-audio-inworld Edge Function using Supabase Management API
 */
...
const FUNCTION_NAME = 'generate-audio-inworld';
...
async function deployFunction() {
  ...
  const metadata = JSON.stringify({
    ...
    verify_jwt: false // Allow internal calls from start-generation-job with service role key
  });

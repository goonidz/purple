...
/**
 * Script to deploy animate-scene Edge Function using Supabase Management API
 */
...
const TEMP_ZIP = path.join(__dirname, '..', 'temp-function.zip');

// No longer needed - we send the file directly
...
async function deployFunction() {
  ...
  // Helper to append to formData buffer
  const append = (str) => {
  ...
  // Add file field (direct TypeScript file)
  append(`--${boundary}\r\n`);

...
export interface VideoRenderOptions {
  ...
  effectType?: 'zoom' | 'pan' | 'pan_old' | 'zoom_subpixel' | 'opencv_zoom' | 'none'; // 'zoom' for Ken Burns, 'pan' for pan effects, 'zoom_subpixel' for experimental smooth zoom, 'opencv_zoom' for OpenCV warpAffine zoom, 'none' for static image

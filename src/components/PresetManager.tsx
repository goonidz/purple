            ...
            {editFormData && (
              <div className="space-y-8 py-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <Textarea
                      placeholder="Entrez votre prompt QA personnalisé pour la vérification des images..."
                      value={editFormData.qaPrompt || ""}
                      onChange={(e) => setEditFormData({ ...editFormData, qaPrompt: e.target.value })}
                      rows={8}
                      className="resize-none font-mono text-xs"
                    />
                    <div className="flex gap-2">
                      ...
                      {editFormData.qaPrompt && (
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => setEditFormData({ ...editFormData, qaPrompt: "" })}
                        >
                          Effacer
                        </Button>
                      )}

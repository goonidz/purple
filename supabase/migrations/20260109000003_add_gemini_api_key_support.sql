-- Add gemini_api_key column to user_api_keys table
ALTER TABLE public.user_api_keys 
ADD COLUMN IF NOT EXISTS gemini_api_key TEXT;

-- Create get_user_api_key function to retrieve API keys (for admin/service use)
...
-- Update store_user_api_key function to support gemini
...
-- Update delete_user_api_key function to support gemini

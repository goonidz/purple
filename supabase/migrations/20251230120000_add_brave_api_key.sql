-- Add brave_api_key column to user_api_keys table
ALTER TABLE public.user_api_keys 
ADD COLUMN IF NOT EXISTS brave_api_key TEXT;

-- Update store_user_api_key function to support brave
...
BEGIN
  ...
  INSERT INTO public.user_api_keys (user_id, eleven_labs_api_key, replicate_api_key, anthropic_api_key, brave_api_key, updated_at)
  VALUES (
    auth.uid(),
...
-- Update delete_user_api_key function to support brave
